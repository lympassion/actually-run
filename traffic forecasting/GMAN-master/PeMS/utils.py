...
def loadData(args):
    ...
    """
    # Traffic
    print(args.traffic_file)

    # df.shape = (52116, 325)，52116表示采样数目，325表示传感器节点
    # 则共有 52116 / (24 * 60 / 5) = 180天——每隔五分钟采样一次
    ...
    # 下面这些所有的计算，看df.index的所有属性就懂了
    dayofweek =  np.reshape(Time.weekday, newshape = (-1, 1))

    delta_second = Time.freq.delta.total_seconds()  # 300，表示5分钟采样一次
